...
import (
	...
	"github.com/linjtf/chattinggpt/internal/domain/entity"
	"github.com/linjtf/chattinggpt/internal/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	if err != nil {
		if err.Error() == "chat not found" {
			...
			if err != nil {
				return nil, errors.New("failed to save new chat: " + err.Error())
			}
	...
	if err != nil {
		return nil, errors.New("failed to create chat completion: " + err.Error())
	}
